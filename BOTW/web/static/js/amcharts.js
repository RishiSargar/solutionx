...
AmCharts.AmChart = AmCharts.Class({
    ...
    drawBackground: function() {
        ...
        this.realHeight = f;
        9 > AmCharts.IEversion && 0 < AmCharts.IEversion && (c = 0.001);
...
AmCharts.AmLegend = AmCharts.Class({
    ...
    arrangeEntries: function() {
        ...
        for (t = 0; t < v.length; t++) {
            ...
            u = A.getBBox();
            var z;
            this.equalWidths ? z = f + y * (r + m + this.markerLabelGap) : (z = x, x = x + u.width + f + m);
            z + u.width > p && 0 < t && 0 !== y && (w++, y = 0, z = f, x = z + u.width + f + m, skipNewRow = !0);
            A.translate(z, (n + l) * w);
            y++;
            !isNaN(k) && y >= k && (y = 0, w++);
            s.push(A)
        ...
        c.toBack();
        b = f;
        if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a) "center" == this.align ? b = f + (h - u.width) / 2 : "right" == this.align && (b = f + h - u.width);
        s.translate(b, l + 1);
    ...
    draw: function() {
        ...
        if (!isNaN(a)) {
            ...
            if (this.show) {
                ...
                "H" != v ? (x = a - t / 2, c = b < h + m + 10 && "down" != v ? b + q : b - m - q) : (2 * q > m && (q = m / 2), c = b - m / 2, x = a < g + (k - g) / 2 ? a + q : a - t - q);
                c + m >= l && (c = l - m);
                c < h && (c = h);
                x < g && (x = g);
                x + t > k && (x = k - t);
                0 < u || 0 === q ? (n = AmCharts.rect(e, t, m, r, this.fillAlpha, this.borderThickness, n, this.borderAlpha, this.cornerRadius), this.showBullet && (e = AmCharts.circle(e, this.bulletSize, r, this.fillAlpha), e.translate(a, b), this.pointer = e)) : (l = [], u = [], "H" != v ? (g = a - x, g > t - q && (g = t - q), g < q && (g = q), l = [0, g - q, a - x, g + q, t, t, 0, 0], u = b < h + m + 10 && "down" != v ? [0, 0, b - c, 0, 0, m, m, 0] : [m, m, b - c, m, m, 0, 0, m]) : (h = b - c, h > m - q && (h = m - q), h < q && (h = q), u = [0, h - q, b - c, h + q, m, m, 0, 0], l = a < g + (k - g) / 2 ? [0, 0, x < a ? 0 : a - x, 0, 0, t, t, 0] : [t, t, x + t > a ? t : a -
                    x, t, t, 0, 0, t
                ]), n = AmCharts.polygon(e, l, u, r, this.fillAlpha, this.borderThickness, n, this.borderAlpha));
                f.push(n);
                n.toFront();
                y && y.toFront();
                d.toFront();
...
AmCharts.TrendLine = AmCharts.Class({
    ...
    draw: function() {
        ...
        h && (k && (d = h.dateToCoordinate(k)), l && (d = h.categoryToCoordinate(l)), m && (e = h.dateToCoordinate(m)), p && (e = h.categoryToCoordinate(p)));
        n && !t && (isNaN(s) || (d = n.getCoordinate(s)), isNaN(q) || (e = n.getCoordinate(q)));
        r && !t && (isNaN(v) || (f = r.getCoordinate(v)), isNaN(u) || (g = r.getCoordinate(u)));
...
AmCharts.AmRadarChart = AmCharts.Class({
    ...
    formatString: function(a, b) {
        ...
        c = c.numberFormatter;
        c || (c = this.numberFormatter);
        a = AmCharts.formatValue(a, b.values, ["value"], c, "", this.usePrefixes, this.prefixesOfSmallNumbers, this.prefixesOfBigNumbers); - 1 != a.indexOf("[[") && (a = AmCharts.formatDataContextValue(a, b.dataContext));
...
AmCharts.ValueAxis = AmCharts.Class({
                ...
                if (0 < y) {
                    ...
                    for (d = this.fillAlpha = 0; d < y; d++) {
                        var A = w[d],
                            z = NaN,
                            H = A.above;
                        isNaN(A.toValue) || (z = this.getCoordinate(A.toValue), t = new this.axisItemRenderer(this, z, "", !0, NaN, NaN, A), this.pushAxisItem(t, H));
                        var E = NaN;
                        isNaN(A.value) || (E = this.getCoordinate(A.value), t = new this.axisItemRenderer(this, E, A.label, !0, NaN, (z - E) / 2, A), this.pushAxisItem(t, H));
                        isNaN(z - E) || (t = new this.guideFillRenderer(this, E, z, A), this.pushAxisItem(t, H), t = t.graphics(), A.graphics = t, A.balloonText && this.addEventListeners(t, A))
                    }
                    this.fillAlpha = x
                }
                w = !1;
                ...
                for (d = n; d < s; d += r)
                    if (n = this.step * d + this.min, n = AmCharts.roundTo(n, this.maxDecCount + 1), !this.integersOnly || Math.round(n) == n)
                        if (isNaN(v) || Number(AmCharts.toFixed(n, v)) == n) {
                            !0 === h && (0 === n && (n = this.minReal), 2 < q && (n = Math.pow(10, d)), w = -1 != String(n).indexOf("e") ? !0 : !1);
                            this.useScientificNotation && (w = !0);
                            this.usePrefixes && (w = !1);
                            w ? (t = -1 == String(n).indexOf("e") ? n.toExponential(15) : String(n), t = t.split("e"), c = Number(t[0]), t = Number(t[1]), c = AmCharts.roundTo(c, 14), 10 == c && (c = 1, t += 1), t = c + "e" + t, 0 === n && (t = "0"), 1 == n && (t = "1")) : (h && (c = String(n).split("."), u.precision = c[1] ? c[1].length : -1), t = this.usePrefixes ? AmCharts.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, u, !0) : AmCharts.formatNumber(n, u, u.precision));
                            this.duration && (t = AmCharts.formatDuration(n, this.duration, "", this.durationUnits, this.maxInterval, u));
                            ...
                            if (n == this.baseValue && "radar" != k) {
                                var I, K, y = this.viW,
                                    ...
                                    n = this.viX;
                                t = this.viY;
                                "H" == this.orientation ? 0 <= c && c <= y + 1 && (I = [c, c, c + e], K = [x, 0, f]) : 0 <= c && c <= x + 1 && (I = [0, y, y + e], K = [c, c, c + f]);
                                I && (c = AmCharts.fitToBounds(2 * this.gridAlpha, 0, 1), c = AmCharts.line(a.container, I, K, this.gridColor, c, 1, this.dashLength), c.translate(n, t), this.grid0 = c, a.axesSet.push(c), c.toBack())
                            }
                        } d = this.baseValue;
    ...
    stackGraphs: function(a) {
        ...
        var c = [],
            ...
            n = !1;
        if ("line" == a || "step" == a || "smoothedLine" == a) n = !0;
        ...
        for (k = this.start; k <= this.end; k++) {
            ...
            for (p = 0; p < h.length; p++)
                if (m = h[p], !m.hidden && (l = m.type, m.chart == this.chart && m.valueAxis == this && a == l && m.stackable && (l = this.data[k].axes[this.id].graphs[m.id], g = l.values.value, !isNaN(g)))) {
                    ...
                    m = m.fillToGraph;
                    n && m && (m = this.data[k].axes[this.id].graphs[m.id]) && (l.values.open = m.values.value);
            ...
            if (this.parseDates && !this.equalSpacing) {
                ...
                if (0 < this.gridCount)
                    for (b = d; b <= g; b++) {
                        ...
                        q = !1;
                        this.nextPeriod[n] && (q = this.checkPeriodChange(this.nextPeriod[n], 1, a, m));
                        t = !1;
                ...
                if (this.cellWidth = this.getStepWidth(b), b < g && (g = b), f += this.start, this.stepWidth = this.getStepWidth(b), 0 < g)
                    for (u = Math.floor(b / g), l = f, l / 2 == Math.round(l / 2) && l--, 0 > l && (l = 0), g = 0, b = l; b <= this.end + 2; b++)
                        if (0 <= b && b < this.data.length ? (n = this.data[b], m = n.category) : m = "", b / u == Math.round(b / u) || n.forceShow) {
                            ...
                            v = 0;
                            "start" == this.gridPosition && (l -= this.cellWidth / 2, v = this.cellWidth / 2);
                            ...
                            m = new this.axisItemRenderer(this, l, m, !0, s, v, void 0, !1, v);
                            this.pushAxisItem(m)
                        }
...
AmCharts.RecAxis = AmCharts.Class({
    construct: function(a) {
        var b = a.chart,
            ...
            p = a.viW,
            r = b.container;
        "H" == a.orientation ? (d = AmCharts.line(r, [0, p], [0, 0], d, e, c), this.axisWidth = a.width, "bottom" == a.position ? (a = c / 2 + f + m + l - 1, c = k) : (a = -c / 2 - f + l + h, c = g + k)) : (this.axisWidth = a.height, "right" == a.position ? (d = AmCharts.line(r, [0, 0, -g], [0, m, m - h], d, e, c), a = l + h, c = c / 2 + f + g + p + k - 1) : (d = AmCharts.line(r, [0, 0], [0, m], d, e, c), a = l, c = -c / 2 - f + k));
        d.translate(c, a);
        b.axesSet.push(d);
        this.set = d
    }
...
AmCharts.RecItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g, h, k) {
        ...
        if ("H" == Fa) {
            ...
            X = "end";
            if (!0 === K && "left" == da || !1 === K && "right" == da) X = "start";
            B = b - m / 2;
            1 == I && 0 < z && !g && (d = AmCharts.fitToBounds(b, 0, T), ha = AmCharts.fitToBounds(ha, 0, T), Y = d - ha, fill = AmCharts.polygon(r, [0, a.width, a.width, 0], [0, 0, Y, Y], A, z), fill.translate(S, d - Y + Q), n.push(fill));
            B += m / 2;
            "right" == da ? (G += S + R + W, B += Q, K ? (G -= u + 4, f || (B -= m / 2 + 3)) : (G += u + 4 + s, B -= 2)) : K ? (G += u + 4 - W, f || (B -= m / 2 + 3), g && (G += S, B += Q)) : (G += -u - s - 4 - 2 - W, B -= 2);
            ma && ("right" == da ? ($ += S + W + R, ka += Q, $ = K ? $ - s : $ + s) : ($ -= W, K || ($ -= u + s)));
            f && (B += f);
            K = -3;
            "right" == da && (K += Q);
            U && (B > T + 1 || B < K) && (U.remove(), U = null)
        }
        ma && ma.translate($, ka);
        !1 === a.visible && (ma && ma.remove(), U && (U.remove(), U = null));
        U && (U.attr({
            "text-anchor": X
...
AmCharts.RadItem = AmCharts.Class({
    construct: function(a, b, c, d, e, f, g) {
        ...
        if (0 < s) {
            ...
            } else s = AmCharts.circle(m, b, "#FFFFFF", 0, q, v, s);
            s.translate(f, E);
            d.push(s)
        }
        if (1 == e && 0 < w && !g) {
...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createSerialGraph: function() {
        ...
        var ea = [],
            ...
            Ja = !1;
        if ("line" == g || "step" == g || "smoothedLine" == g)
            if (this.stackable && "regular" == E || "100%" == E || this.fillToGraph) Ja = !0;
        for (O = K; O <= S; O++) {
            U = d[O];
            ...
            if (sa) {
                ...
                var na = U.x[Fa.id],
                    ta = Math.floor($ / 2),
                    Na = ta;
                "start" == this.pointPosition && (na -= $ / 2, ta = 0, Na = $);
                Q || (F.x = na); - 1E5 > na && (na = -1E5);
                na > k + 1E5 && (na = k + 1E5);
                p ? (D = C, P = N, N = C = na, isNaN(ia) && !this.fillToGraph && (P = da), Ka = za, La = Aa) : (P = D = na, isNaN(ia) && !this.fillToGraph && (N = da));
                V < ia && (F.isNegative = !0, Ga && (wa = Ga), Ia && (Ma = Ia), void 0 != ya && (qa = ya));
                switch (g) {
                    case "line":
                            ...
                            if (!(V < rb && ia < rb || V > sb && ia > sb))
                                if (p) {
                                    ...
                                    if (M < l && 0 < J && (la = new AmCharts.Cuboid(e, aa, J, z - a.d3x, H - a.d3y, wa, Ma, R, ja, W, G, n, p), "bottom" != I))
                                        if (I = f.reversed ? "left" : "right", 0 > V) I = f.reversed ? "right" : "left";
                                        else if ("regular" == E || "100%" == E) Z += this.dx
                                } else {
                                    ...
                                    if (L < k + T * z && 0 < J)
                                        if (la = new AmCharts.Cuboid(e, J, aa, z - a.d3x, H - a.d3y, wa, Ma, R, ja, this.lineAlpha, G, n, p), 0 > V && "middle" != I) I = "bottom";
                                        else if (I = ka, "regular" == E || "100%" == E) ca += this.dy
                                } if (la && (ra = la.set, ra.translate(L, M), this.columnsSet.push(ra), (F.url || this.showHandOnHover) && ra.setAttr("cursor", "pointer"), !Q)) {
                                "none" == E && (A = p ? (this.end + 1 - O) * x - c : x * O + c);
                                "3d" == E && (p ? (A = (x - c) * (this.end + 1 - O), Z += z * this.columnIndex, oa += z * this.columnIndex, F.y += z * this.columnIndex) : (A = (x - c) * (O + 1), Z += 3, ca += H * this.columnIndex + 7, pa += H * this.columnIndex, F.y += H * this.columnIndex));
                        ...
                        if (!isNaN(ia) && !isNaN(V)) {
                            ...
                            if (p) {
                                if (M = C - h / 2, L = P, J = h, M + J > l && (J = l - M), 0 > M && (J += M, M = 0), M < l && 0 < J) {
                                    var fb, gb;
                                    V > ia ? (fb = [D, La], gb = [P, Ka]) : (fb = [P, La], gb = [D, Ka]);
                                    !isNaN(La) && !isNaN(Ka) && C < l && 0 < C && (Va = AmCharts.line(e, fb, [C, C], ja, W, R), eb = AmCharts.line(e, gb, [C, C], ja, W, R));
                                    aa = D - P;
                                ...
                                var la = new AmCharts.Cuboid(e, J, aa, z, H, wa, Ma, R, ja, W, G, n, p),
                                    hb, ib;
                                V > ia ? (hb = [C, Aa], ib = [N, za]) : (hb = [N, Aa], ib = [C, za]);
                                !isNaN(Aa) && !isNaN(za) && D < k && 0 < D && (Va = AmCharts.line(e, [D, D], hb, ja, W, R), eb = AmCharts.line(e, [D, D], ib, ja, W, R))
                            }
                    ...
                    case "ohlc":
                        if (!(isNaN(ia) || isNaN(cb) || isNaN(db) || isNaN(V))) {
                            ...
                            if (p) {
                                ...
                                0 < C && C < l && (jb = AmCharts.line(e, [Ka, La], [C, C], qa, W, R, X));
                                ...
                                0 < D && D < k && (jb = AmCharts.line(e, [D, D], [za, Aa], qa, W, R, X));
                        ...
                        if ("column" == g && "regular" == E || "100%" == E) {
                            ...
                            if (zb) {
                                ...
                                var Ab = Ea.getBBox(),
                                    ...
                                    Oa, Pa, Db = f.totals[O];
                                Db && Db.remove();
                                p ? (Pa = C, Oa = 0 > V ? D - Bb / 2 - 2 : D + Bb / 2 + 3) : (Oa = D, Pa = 0 > V ? C + Cb / 2 : C - Cb / 2 - 3);
                                Ea.translate(Oa, Pa);
                                f.totals[O] = Ea;
    ...
    drawSmoothedGraph: function(a, b, c, d) {
        if (1 < a.length) {
            ...
            g.push(v.path);
            void 0 !== r && (k = new AmCharts.Bezier(f, a, b, r, k, l, p, 0, e), h.push(k.path));
            0 < m && (l = a.join(";").split(";"), v = b.join(";").split(";"), k = "", 0 < c.length ? (c.reverse(), d.reverse(), l = a.concat(c), v = b.concat(d)) : (this.rotate ? (k += " L" + q + "," + b[b.length - 1], k += " L" + q + "," + b[0]) : (k += " L" + a[a.length - 1] + "," + q, k += " L" + a[0] + "," + q), k += " L" + a[0] + "," + b[0]), c = new AmCharts.Bezier(f, l, v, NaN, 0, 0, p, m, e, k), g.push(c.path), n || void 0 !== r) && (s || (s = m), n || (n = r), a = new AmCharts.Bezier(f, a, b, NaN, 0, 0, n, s, e, k), h.push(a.path));
            this.applyMask(h, g)
        }
    },
    ...
    createBullet: function(a, b, c, d) {
        ...
        if ("none" != this.bullet || a.bullet) {
            ...
            switch (g) {
                case "round":
                    ...
                    break;
                case "square":
                    h = AmCharts.polygon(d, [0, f, f, 0], [0, 0, f, f], k, r, l, m, p);
                    b -= f / 2;
                    c -= f / 2;
                    e = -f / 2;
                    break;
        ...
        h && ((a.url || this.showHandOnHover) && h.setAttr("cursor", "pointer"), "serial" == this.chartType && (b - g < e || b - g > this.width || c < -f / 2 || c - l > this.height) && (h.remove(), h = null), h && (this.bulletSet.push(h), h.translate(b, c), this.addListeners(h, a), this.allBullets.push(h)));
        return f
    },
...
AmCharts.ChartCursor = AmCharts.Class({
    ...
    createCursor: function() {
        ...
        this.set.push(b);
        a ? (e && (g.pointerWidth = 0), "right" == d ? e ? g.setBounds(p, r + m, p + n + l, r + s + m) : g.setBounds(p + n + l + f, r + m, p + n + 1E3, r + s + m) : e ? g.setBounds(p, r, n + p, s + r) : g.setBounds(-1E3, -1E3, p - q - f, r + s + 15)) : (g.maxWidth = n, c.parseDates && (q = 0, g.pointerWidth = 0), "top" == d ? e ? g.setBounds(p + l, r + m, n + l + p, s + r) : g.setBounds(p + l, -1E3, n + l + p, r + m - q - f) : e ? g.setBounds(p, r, n + p, s + r - q) : g.setBounds(p, r + s + q + f - 1, p + n, r + s + q + f));
        this.hideCursor()
    },
            ...
            if (r) {
                ...
                if (c.mouseIsOver || A || z || this.forceShow)
                    if (this.forceShow = !1, z) {
                        ...
                        A && (s ? this.updateSelectionSize(NaN, n) : this.updateSelectionSize(n, NaN));
                        t = !0;
                        A && (t = !1);
                        this.categoryBalloonEnabled && t ? (s ? (q && ("right" == x ? u.setBounds(k, l + h, k + m + g, l + n + h) : u.setBounds(k, l + h, k + m + g, l + n)), "right" == x ? q ? u.setPosition(k + m + g, l + n + h) : u.setPosition(k + m + g + E, l + n + h) : q ? u.setPosition(k, l + n) : u.setPosition(k - E, l + n)) : "top" == x ? q ? u.setPosition(k + n + g, l + h) : u.setPosition(k + n + g, l + h - E + 1) : q ? u.setPosition(k + n, l + p) : u.setPosition(k + n, l + p + E - 1), (w = this.categoryBalloonFunction) ? u.showBalloon(w(r.category)) : f.parseDates ? (f = AmCharts.formatDate(r.category, this.categoryBalloonDateFormat), -1 != f.indexOf("fff") && (f = AmCharts.formatMilliseconds(f, r.category)), u.showBalloon(f)) : u.showBalloon(r.category)) : u.hide();
...
AmCharts.wedge = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    n ? (H || (e = " A" + p(b - f) + "," + p(c - g) + "," + p(b + f) + "," + p(c + g) + "," + p(u) + "," + p(t) + "," + p(w) +
        "," + p(y)), f = " M" + p(s) + "," + p(v) + " L" + p(u) + "," + p(t) + e + " L" + p(x) + "," + p(q)) : f = " M" + s + "," + v + " L" + u + "," + t + (" A" + f + "," + g + ",0," + z + ",1," + w + "," + y) + " L" + x + "," + q;
    0 < h && (n ? H || (f += " B" + (b - h) + "," + (c - r) + "," + (b + h) + "," + (c + r) + "," + x + "," + q + "," + s + "," + v) : f += " A" + h + "," + r + ",0," + z + ",0," + s + "," + v);
    ...
    drawChart: function() {
        ...
        if (AmCharts.ifArray(b)) {
            if (0 < a.realWidth && 0 < a.realHeight) {
                ...
                n || (e = 0 <= s ? e - h - k - 2 * q : e - h - k, f = f - l - m, n = Math.min(e, f), f < e && (n /= 1 - a.angle / 90, n > e && (n = e)), a.pullOutRadiusReal = AmCharts.toCoordinate(a.pullOutRadius, n), n = 0 <= s ? n - 1.8 * (s + a.pullOutRadiusReal) : n - 1.8 * a.pullOutRadiusReal, n /= 2);
...
AmCharts.AmXYChart = AmCharts.Class({
    ...
    createValueAxes: function() {
        ...
        0 === b.length && (d = new AmCharts.ValueAxis, d.rotate = !1, d.setOrientation(!1), c.push(d), b.push(d));
